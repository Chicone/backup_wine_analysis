...
from classification import (Classifier, process_labels, assign_country_to_pinot_noir, assign_origin_to_pinot_noir,
                            ...
                            assign_north_south_to_beaune, assign_category_to_press_wine)
...
if __name__ == "__main__":
    ...
    # xlsx_path = os.path.expanduser('~/Documents/datasets/Press_wines_2022/Tot_Chromato_2022_MERLOT_PRESSE_MIS_EN_FORME_SM.xlsx')
    xlsx_path = os.path.expanduser('~/Documents/datasets/Press_wines_2022/Tot_Chromato_2022_CABERNET_SAUV_PRESSE_MIS_EN_FORME_SM.xlsx')

    # npy_path = os.path.expanduser('~/PycharmProjects/wine_analysis/data/press_wines/merlot22.npy')
    npy_path = os.path.expanduser('~/PycharmProjects/wine_analysis/data/press_wines/cabernet22.npy')
    ...
    basedir = '~/PycharmProjects/wine_analysis/data/press_wines/'
    ...
    elif 'press_wines' in basedir.lower():
        wine_kind = 'press_wines'

    cl = ChromatogramAnalysis(
        os.path.expanduser(basedir + 'merlot22.npy'),
        os.path.expanduser(basedir + 'cabernet22.npy')
        )
    ...
    # chromatograms1.pop(next(iter(chromatograms1)))
    # chromatograms1.pop(next(iter(chromatograms1)))
    # chromatograms1.pop(next(iter(chromatograms1)))
    ...
    if sync_chroms == True:
        ...
        # # )
        synced_chromatograms1 = {key: value for key, value in synced_chromatograms1.items()}
    ...
    labels1 = assign_category_to_press_wine(labels1)
    labels2 = assign_category_to_press_wine(labels2)
